...
export const mockLocations: ClinicLocation[] = [
  {
    ...
    address:
      "Ground Flr, Ma'am Olives Hotel, 18 Kessing St, Olongapo City, 2200 Zambales",
    lat: 14.83, // Approximate for Olongapo
    lng: 120.28,
    googleMapsUrl:
      "https://www.google.com/maps/search/?api=1&query=Ma%27am+Olives+Hotel+Olongapo",
  },
  {
    id: "2",
    ...
    address:
      "DanielDanica Ombao Building, Nagbunga, Castillejos, 2208 Zambales",
    lat: 14.93, // Approximate for Castillejos
    lng: 120.19,
    googleMapsUrl:
      "https://www.google.com/maps/search/?api=1&query=DanielDanica+Ombao+Building+Castillejos",
  },
];
